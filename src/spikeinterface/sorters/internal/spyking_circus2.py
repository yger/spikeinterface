...
class Spykingcircus2Sorter(ComponentsBasedSorter):
    ...
    _default_params = {
        ...
        "matching": {"method": "circus-omp", "method_kwargs": dict(), "gather_mode": "memory"},
    ...
    def _run_from_folder(cls, sorter_output_folder, params, verbose):
        ...
        peaks = detect_peaks(
            recording_w, method=detection_method, method_kwargs=detection_params, job_kwargs=job_kwargs
        )
