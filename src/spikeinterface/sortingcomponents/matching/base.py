...
class BaseTemplateMatching(PeakDetector):
    def __init__(self, recording, templates):
        ...
        PeakDetector.__init__(self, recording, return_output=True, parents=None)
    ...
    def clean(self):
        """
        Clean the matching output.
        This is called at the end of the matching process.
        """
